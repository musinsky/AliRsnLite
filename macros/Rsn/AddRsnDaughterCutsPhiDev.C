...
#include <AliRsnActPairPID.h>
#include <RESONANCES/AliRsnCutPID.h>
#include <RESONANCES/AliRsnCutKaonForPhi2010PP.h>
#include <RESONANCES/AliRsnCutValue.h>
#endif
Int_t AddRsnDaughterCutsPhiDev(AliPID::EParticleType type1,AliPID::EParticleType type2,TString opt,Bool_t isRsnMini=kFALSE,AliRsnInputHandler *rsnIH=0,AliAnalysisTaskSE *task=0)
{
...
//       type1 = AliPID::kPion;
   ...
   if (isRsnMini) {
      ...
      TObjArray *acts = sel->GetActions();
      AliRsnActPairPID *pairPID = new AliRsnActPairPID("pairPID","mvala's pair PID");
      acts->Add(pairPID);
