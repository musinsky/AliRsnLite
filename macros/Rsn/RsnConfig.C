...
//    mon->AddOutput(outMonitordEdxTOF);
   ...
   // add outputs to loop
   mon->AddOutput(outMonitorTPCnsigmaK);
   ...
   // add outputs to loop
   mon->AddOutput(outMonitorTPCnsigmaPi);
   ...
   // add outputs to loop
   mon->AddOutput(outMonitorTPCnsigmaP);
   ...
   // add outputs to loop
   mon->AddOutput(outMonitorTOFnsigmaK);
   ...
   // add outputs to loop
   mon->AddOutput(outMonitorTOFnsigmaPi);
   ...
   // add outputs to loop
   mon->AddOutput(outMonitorTOFnsigmaP);
